...
require 'poise_spec/version'

Gem::Specification.new do |spec|
  spec.name = 'poise-spec'
  spec.version = PoiseSpec::VERSION
  spec.authors = ['Noah Kantrowitz']
  spec.email = %w{noah@coderanger.net}
  spec.description = 'An RSpec helper module for writing unit tests for library-oriented Chef cookbooks.'
  spec.summary = spec.description
  spec.homepage = 'https://github.com/poise/poise-spec'
